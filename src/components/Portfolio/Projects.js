...
const Projects = () => (
  <section id="projects" className="section-border">
    ...
    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(360px, 1fr))', borderTop: '1px solid var(--line)' }}>
      {projects.map((p, i) => (
        <div key={i} style={{ padding: '34px 40px', borderRight: '1px solid var(--line)' }}>
